...
import type { DonationRecord as _DonationRecord, DonationRequest as _DonationRequest, ExternalBlob as _ExternalBlob, OrderDetails as _OrderDetails, OrderId as _OrderId, OrderStatus as _OrderStatus, PaymentMethod as _PaymentMethod, PaymentResult as _PaymentResult, ProductDetails as _ProductDetails, ProductId as _ProductId, ShoppingCart as _ShoppingCart, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: ProductDetails): Promise<ProductDetails> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(await to_candid_ProductDetails_n8(this._uploadFile, this._downloadFile, arg0));
                return from_candid_ProductDetails_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async addToCart(arg0: string, arg1: ProductId, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createOrder(arg0: string, arg1: PaymentMethod): Promise<OrderDetails | null> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrder(arg0, to_candid_PaymentMethod_n16(this._uploadFile, this._downloadFile, arg1));
    ...
    async donate(arg0: DonationRequest): Promise<DonationRecord> {
        if (this.processError) {
            try {
                const result = await this.actor.donate(to_candid_DonationRequest_n25(this._uploadFile, this._downloadFile, arg0));
                return from_candid_DonationRecord_n27(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getCart(arg0: string): Promise<ShoppingCart | null> {
        if (this.processError) {
            try {
    ...
    async getProduct(arg0: ProductId): Promise<ProductDetails | null> {
        if (this.processError) {
            try {
    ...
    async getProducts(): Promise<Array<ProductDetails>> {
        if (this.processError) {
            try {
    ...
    async processCoinbasePayment(arg0: OrderId): Promise<PaymentResult> {
        if (this.processError) {
            try {
                const result = await this.actor.processCoinbasePayment(arg0);
                return from_candid_PaymentResult_n40(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async removeFromCart(arg0: string, arg1: ProductId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async setOrderStatus(arg0: OrderId, arg1: OrderStatus): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setOrderStatus(arg0, to_candid_OrderStatus_n43(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeFile(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeFile(await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async storeImage(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeImage(await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: ProductDetails): Promise<ProductDetails> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(await to_candid_ProductDetails_n8(this._uploadFile, this._downloadFile, arg0));
                return from_candid_ProductDetails_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_DonationRecord_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DonationRecord): DonationRecord {
...
function from_candid_OrderDetails_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OrderDetails): OrderDetails {
...
function from_candid_PaymentResult_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PaymentResult): PaymentResult {
    return from_candid_record_n41(_uploadFile, _downloadFile, value);
}
async function from_candid_ProductDetails_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProductDetails): Promise<ProductDetails> {
...
function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OrderDetails]): OrderDetails | null {
    return value.length === 0 ? null : from_candid_OrderDetails_n19(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ShoppingCart]): ShoppingCart | null {
    return value.length === 0 ? null : value[0];
}
async function from_candid_opt_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProductDetails]): Promise<ProductDetails | null> {
    return value.length === 0 ? null : await from_candid_ProductDetails_n11(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n42(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OrderId]): OrderId | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n41(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        orderId: record_opt_to_undefined(from_candid_opt_n42(_uploadFile, _downloadFile, value.orderId)),
        message: value.message,
...
function from_candid_variant_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "shipped" in value ? OrderStatus.shipped : "pending" in value ? OrderStatus.pending : "completed" in value ? OrderStatus.completed : value;
}
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "stripe" in value ? PaymentMethod.stripe : "coinbaseICP" in value ? PaymentMethod.coinbaseICP : value;
}
...
function from_candid_vec_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_OrderDetails>): Array<OrderDetails> {
    return value.map((x)=>from_candid_OrderDetails_n19(_uploadFile, _downloadFile, x));
}
async function from_candid_vec_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProductDetails>): Promise<Array<ProductDetails>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ProductDetails_n11(_uploadFile, _downloadFile, x)));
}
function to_candid_DonationRequest_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: DonationRequest): _DonationRequest {
...
async function to_candid_ProductDetails_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductDetails): Promise<_ProductDetails> {
...
function to_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PaymentMethod): {
    ...
    return value == PaymentMethod.stripe ? {
        stripe: null
    } : value == PaymentMethod.coinbaseICP ? {
        coinbaseICP: null
    } : value;
}
